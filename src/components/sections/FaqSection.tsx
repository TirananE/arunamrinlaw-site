          ...
          <div className="col-lg-6 col-md-12 col-sm-12 col-12">
            <div className="faq_content" data-aos="fade-up">
              ...
              <p className="text text-size-16">
                Duisruam est qui dolorem ipsum quia dolor sit amer adipisci
                velit, sed nuia non numuam.
              </p>
                      ...
                      >
                        <div className="card-body">
                          <p className="text-size-16 text-left mb-0">
                            Our experienced insurance agents can help you assess
                            your family&apos;s needs and recommend the
                            appropriate coverage options based on factors such
                            as your family size
                          </p>
                        </div>
                      </div>
